...
public class BalanceEnquaryServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		pw.print(
				"<tr><td>CardNumber:</td><td><input type ='text' name='txtCard' placeholder='enter the Card number'></td></tr>");
		pw.print(
				"<tr><td>Pin:</td><td><input type ='text' name='txtPin' placeholder='enter the Pin number'></td></tr>");
		// pw.print("<tr><td>Amount:</td><td><input type ='text' name='txtAmount'
		// placeholder='enter the Amount'></td></tr>");
